...
const features = [
    { 
        ...
        desc: 'Get instant feedback on code quality, security vulnerabilities, performance issues, and best practices.'
    },
    {
        title: 'Expert Mentorship', 
        icon: <Users className="h-8 w-8 text-primary-600" />, 
        desc: 'Connect with experienced developers for personalized guidance and code reviews.'
    },
    { 
        title: 'Multi-Language Support', 
        icon: <Code className="h-8 w-8 text-primary-600" />, 
        desc: 'Support for JavaScript, Python, Java, C++, and many more programming languages.'
    },
    { 
        title: 'Security Focus', 
        icon: <Shield className="h-8 w-8 text-primary-600" />, 
        desc: 'Identify security vulnerabilities and learn secure coding practices with detailed explanations.' 
    }, 
    { 
        title: 'Progress Tracking', 
        icon: <TrendingUp className="h-8 w-8 text-primary-600" />, 
        desc: 'Track your improvement over time with detailed analytics and personalized learning paths.' 
    }, 
    { 
        title: 'Learning Resources', 
        icon: <CheckCircle className="h-8 w-8 text-primary-600" />, 
        desc: 'Access curated learning materials and tutorials based on your specific areas for improvement.'
    }
]

const stepColors = ['bg-teal-600', 'bg-emerald-500', 'bg-cyan-500'];
    ...
    return (
        <div className="bg-white font-poppins">
            ...
            <motion.section
                ...
                custom={0}
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-15 sm:py-20 lg:py-28 text-center">
                    <motion.h1
                    ...
                    >
                        <Button variant="primary" size="lg">
                            <Link to="/signup" className="btn-primary inline-flex items-center justify-center">Start Free Trial <ArrowRight className="ml-2 h-5 w-5" /></Link>
                        </Button>
                        <Button variant="secondary" size="lg">
                            <Link to="/demo" className="btn-secondary inline-flex items-center justify-center">View Demo</Link>
                        </Button>
                    </motion.div>
                </div>
            </motion.section>
            ...
            <section className="py-20 bg-white" aria-label="Features">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <motion.div
                            className="text-center p-6 bg-white rounded-xl shadow-md border border-gray-200 cursor-pointer hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                            key={index}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <motion.div key={i} className="text-center" variants={fadeUp} custom={i + 1}>
                            <div className={`w-12 h-12 ${stepColors[i]} text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold`}>
                            {i + 1}
                            </div>
